...
dotnet tool install MackySoft.AgentSkills.Cli --version 0.8.2
```
...
```bash
dotnet add <PROJECT>.csproj package MackySoft.AgentSkills.Hosting --version 0.8.2
```
...
```bash
dotnet add <PROJECT>.csproj package MackySoft.AgentSkills.ConsoleAppFramework --version 0.8.2

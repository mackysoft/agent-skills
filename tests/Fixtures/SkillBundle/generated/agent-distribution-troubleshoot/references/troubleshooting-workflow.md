...
Use this reference when a Agent Distribution command fails or returns uncertain state.
...
6. Operation failure: run `agent-distribution ops describe <opName>` and compare the request with the runtime contract.

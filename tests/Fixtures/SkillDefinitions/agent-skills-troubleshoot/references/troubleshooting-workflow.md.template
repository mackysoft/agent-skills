...
Use this reference when a Agent Skills command fails or returns uncertain state.
...
6. Operation failure: run `agent-skills ops describe <opName>` and compare the request with the runtime contract.

...
namespace MackySoft.AgentSkills.Tests.Agents.Installation.Services;
...
public sealed class AgentOperationServiceTests
{
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-skills-agent-operations", "install");
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-skills-agent-operations", "install-blocked");
        var skills = await SkillTestData.GenerateFixturePackagesAsync();
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-skills-agent-operations", "install-collision");
        var skills = await SkillTestData.GenerateFixturePackagesAsync();
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-skills-agent-operations", "update-force");
        var skills = await SkillTestData.GenerateFixturePackagesAsync();
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-skills-agent-operations", "uninstall");
        var skills = await SkillTestData.GenerateFixturePackagesAsync();
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-skills-agent-operations", "prune");
        var skills = await SkillTestData.GenerateFixturePackagesAsync();
        var agent = AgentOperationTestData.CreateAgent(skills, "architect", "architect.toml", "agent\n", [skills[0].Manifest.SkillName]);
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-skills-agent-operations", "prune-name-filter");
        var skills = await SkillTestData.GenerateFixturePackagesAsync();
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-skills-agent-operations", "prune-collision");
        var skills = await SkillTestData.GenerateFixturePackagesAsync();
        var agent = AgentOperationTestData.CreateAgent(skills, "architect", "architect.toml", "agent\n");
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-skills-agent-operations", "doctor");
        var skills = await SkillTestData.GenerateFixturePackagesAsync();
        var agent = AgentOperationTestData.CreateAgent(skills, "architect", "architect.toml", "agent\n", [skills[0].Manifest.SkillName]);
        var catalog = AgentOperationTestData.CreateCatalog(skills, [agent], [skills[0]]);
        var targets = CreateTargets(scope.FullPath);

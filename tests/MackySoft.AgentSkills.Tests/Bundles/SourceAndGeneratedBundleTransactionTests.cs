...
public sealed class SourceAndGeneratedBundleTransactionTests
{
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-skills-bundles", "transaction-source-failure");
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-skills-bundles", "transaction-new-source-failure");
        scope.WriteFile("bundle.json", "original source\n");
        var transaction = new SourceAndGeneratedBundleTransaction(
            static (_, _, _) => ValueTask.FromException(new IOException("Injected source publication failure.")));
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-skills-bundles", "transaction-source-cancel");
        scope.WriteFile("bundle.json", "original source\n");
        scope.WriteFile("generated/bundle.json", "original generated\n");
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-skills-bundles", "transaction-generated-link");
        using var outside = TestDirectories.CreateTempScope("agent-skills-bundles", "transaction-generated-link-outside");
        scope.WriteFile("bundle.json", "original source\n");
        try
        {

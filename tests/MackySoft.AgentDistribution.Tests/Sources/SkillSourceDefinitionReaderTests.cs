...
public sealed class SkillSourceDefinitionReaderTests
{
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "derived-category");
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "fixed-depth");
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "legacy-flat-layout");
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "invalid-category");
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "empty-category");
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "duplicate-across-categories");
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "unknown-property");
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "redundant-category");
        var skillDirectory = WriteMinimalDefinition(scope, extraJsonProperty: ",\n  \"category\": \"core\"");
        var reader = new SkillSourceDefinitionReader();
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "redundant-skill-name");
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "redundant-references");
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "property-order");
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "malformed-json");
        var skillDirectory = scope.CreateDirectory("core/sample-skill");
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "unsupported-schema");
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "no-references");
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "derived-references");
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "template-heading");
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "sorted-dependencies");
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "invalid-dependency");
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "duplicate-dependency");
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "self-dependency");
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "undefined-dependency");
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "dependency-cycle");
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "invalid-reference-name");
        var skillDirectory = WriteMinimalDefinition(scope, references: [], writeReferenceTemplates: false);
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "nested-reference");
        var skillDirectory = WriteMinimalDefinition(scope, references: [], writeReferenceTemplates: false);
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "unsafe-skill-name");
    ...
    public async Task ReadOneAsync_RejectsSkillTemplateSymlinkOutsideSkillDirectory ()
    {
        ...
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "template-symlink");
    ...
    public async Task ReadOneAsync_RejectsReferenceTemplateSymlinkOutsideSkillDirectory ()
    {
        ...
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "reference-symlink");
        using var outsideScope = TestDirectories.CreateTempScope("agent-distribution-skills", "reference-symlink-outside");

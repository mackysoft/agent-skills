...
public sealed class SkillCatalogTargetRootSelectorTests
{
    ...
    [Theory]
    [Trait("Size", "Small")]
    [InlineData(HostKind.Codex, ".agents/skills/com.mackysoft.agent-distribution.tests")]
    [InlineData(HostKind.ClaudeCode, ".claude/skills")]
    [InlineData(HostKind.GitHubCopilot, ".github/skills/com.mackysoft.agent-distribution.tests")]
    public async Task SelectTargetAsync_ProjectScope_AppliesHostCatalogLayout (
        HostKind host,
        string expectedRelativePath)
    {
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "target-project-default");
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "target-user-codex-home");
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "target-user-home-fallback");
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "target-user-claude-home");
        var home = scope.GetPath("home");
        var selector = CreateSelector(home);
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "target-user-copilot-home");
        var home = scope.GetPath("home");
        var selector = CreateSelector(home);
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "target-user-relative-codex-home");
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "target-project-explicit");
        var selector = CreateSelector(scope.GetPath("home"));
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "target-user-explicit");
        var selector = CreateSelector(scope.GetPath("home"));
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "target-compatible-flat");
        var home = scope.GetPath("home");
        var codexHome = scope.GetPath("codex-home");
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "target-split-catalog");
        var packages = await SkillTestData.GenerateFixturePackagesAsync();
    ...
    public async Task SelectTargetAsync_DefaultTarget_RejectsSkillNameOwnedBySiblingCatalog (
        ...
        SkillScopeKind scopeKind)
    {
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "target-sibling-catalog-collision");
        var home = scope.GetPath("home");
        var codexHome = scope.GetPath("codex-home");
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "target-unrelated-sibling-symlink");
        using var outsideScope = TestDirectories.CreateTempScope("agent-distribution-skills", "target-unrelated-sibling-symlink-outside");
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "target-selected-sibling-symlink");
        using var outsideScope = TestDirectories.CreateTempScope("agent-distribution-skills", "target-selected-sibling-symlink-outside");
        var hostRoot = scope.CreateDirectory(Path.Combine(".agents", "skills"));
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "target-flat-skill-nested-directory");
    ...
    {
        using var scope = TestDirectories.CreateTempScope("agent-distribution-skills", "target-explicit-skips-compatible");
        var packages = await SkillTestData.GenerateFixturePackagesAsync();
        var compatibleRoot = scope.GetPath(Path.Combine(".agents", "skills"));

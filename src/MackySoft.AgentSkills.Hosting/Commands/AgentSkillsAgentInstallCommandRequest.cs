...
public sealed class AgentSkillsAgentInstallCommandRequest
{
    /// <summary> Initializes one install request. </summary>
    public AgentSkillsAgentInstallCommandRequest (string? host = null, IReadOnlyList<string>? category = null, IReadOnlyList<string>? agent = null, string? scope = null, string? repositoryRoot = null, string? agentTargetDir = null, string? skillTargetDir = null, bool dryRun = false, bool force = false, bool printDiff = false)
    {
        Host = host;

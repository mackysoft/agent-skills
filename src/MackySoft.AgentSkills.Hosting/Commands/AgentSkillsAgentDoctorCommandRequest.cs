...
public sealed class AgentSkillsAgentDoctorCommandRequest
{
    /// <summary> Initializes one doctor request. </summary>
    public AgentSkillsAgentDoctorCommandRequest (string? host = null, IReadOnlyList<string>? category = null, IReadOnlyList<string>? agent = null, string? scope = null, string? repositoryRoot = null, string? agentTargetDir = null, string? skillTargetDir = null)
    {
        Host = host;

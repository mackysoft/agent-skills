...
/// <summary> Represents raw input for a custom-agent uninstall command. </summary>
public sealed class AgentSkillsAgentUninstallCommandRequest
{
    /// <summary> Initializes one uninstall request. </summary>
    public AgentSkillsAgentUninstallCommandRequest (string? host = null, IReadOnlyList<string>? category = null, IReadOnlyList<string>? agent = null, string? scope = null, string? repositoryRoot = null, string? agentTargetDir = null, bool dryRun = false, bool force = false)
    {
        Host = host;

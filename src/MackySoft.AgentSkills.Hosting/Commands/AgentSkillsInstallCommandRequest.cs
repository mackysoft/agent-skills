...
/// <summary> Represents raw install command input. </summary>
public sealed class AgentSkillsInstallCommandRequest
{
    /// <summary> Initializes raw install command input. </summary>
    ...
    /// <param name="dryRun"> Whether to return the install plan without writing files. </param>
    ...
    public AgentSkillsInstallCommandRequest (
        string? host = null,
    ...
    /// <summary> Gets whether to return the install plan without writing files. </summary>

...
{
    /// <summary> Gets the code emitted when a product-independent SKILL command or request input value is invalid. </summary>
    ...
    /// <summary> Gets the code emitted when the target directory is not managed by a canonical Agent Distribution SKILL manifest. </summary>
    ...
    public static readonly SkillFailureCode InstallTargetRemovedFromCatalog = new("SKILL_INSTALL_TARGET_REMOVED_FROM_CATALOG");

...
/// <summary> Reads generated SKILL packages whose canonical serialization, declared files, and digests are self-consistent. </summary>
/// <remarks> Compatibility with the current built-in host adapters is validated when a package is materialized for a host. </remarks>
public sealed class CanonicalSkillPackageReader
{
    ...
    /// <summary> Reads all intrinsically valid canonical SKILL packages under a package root. </summary>
    /// <param name="packageRoot"> The generated <c>skills</c> directory. </param>
    /// <param name="cancellationToken"> The cancellation token propagated by command execution. </param>
    /// <returns> The self-consistent canonical packages, or a path, serialization, file-set, or digest failure. </returns>

...
public sealed class AgentDistributionCommandResult
{
    ...
    public static AgentDistributionCommandResult Success (
        string command,
        object payload,
        int exitCode = 0)
    {
        ...
        return new AgentDistributionCommandResult(command, payload, null, exitCode);
    }
        ...
        AgentDistributionFailure failure)
    {
        ...
        return new AgentDistributionCommandResult(command, null, failure, 1);
    }
}

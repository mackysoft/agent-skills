...
public sealed class AgentDistributionCommandRuntimeOptions
{
    ...
    /// <summary> Gets or sets the absolute application base directory that contains the bundled <c>agent-distribution</c> directory. This option is required. </summary>

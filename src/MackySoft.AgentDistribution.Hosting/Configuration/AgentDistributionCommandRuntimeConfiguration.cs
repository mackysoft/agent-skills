...
/// <summary> Represents validated, immutable configuration for one Agent Distribution command runtime. </summary>
public sealed class AgentDistributionCommandRuntimeConfiguration
{
    ...
    public AgentDistributionCommandRuntimeConfiguration (
        string productName,

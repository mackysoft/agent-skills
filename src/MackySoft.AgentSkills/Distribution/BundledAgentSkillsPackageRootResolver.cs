...
public sealed class BundledAgentSkillsPackageRootResolver
{
    ...
    public BundledAgentSkillsPackageRootResolver (AbsolutePath packageBaseDirectory)
    {
    ...
    public AbsolutePath Resolve ()
    {
        ...
        throw new DirectoryNotFoundException($"Could not locate bundled agent skills package root: {candidate.Value}");
    }
}

...
public sealed class CanonicalAgentSkillsBundle
{
    /// <summary> Initializes a mixed canonical bundle. </summary>
    internal CanonicalAgentSkillsBundle (AgentSkillsBundleDescriptor descriptor, IReadOnlyList<CanonicalSkillPackage> skills, IReadOnlyList<CanonicalAgentPackage> agents)
    {

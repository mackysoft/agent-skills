...
public sealed class AgentManifest
{
    ...
    internal AgentManifest (int schemaVersion, AgentSkillsBundleVersion bundleVersion, SkillCatalogId catalogId, AgentCategory category, AgentName agentName, string displayName, string description, IReadOnlyList<SkillName> skillDependencies, Sha256Digest contentDigest, Sha256Digest manifestDigest, IReadOnlyList<AgentHostArtifactManifest> hostArtifacts)
    {

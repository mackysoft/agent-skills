...
/// <summary> Creates strict JSON converters for enum types backed by contract literals. </summary>
/// <remarks>
/// Once one member declares <see cref="ContractLiteralAttribute" />, every declared member must be
        ...
        JsonSerializerOptions options)
    {
        if (!CanConvert(typeToConvert))
        {
            throw new ArgumentException(
                $"Type '{typeToConvert.FullName}' is not an enum backed by contract literals.",

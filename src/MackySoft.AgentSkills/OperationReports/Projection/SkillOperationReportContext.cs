...
public sealed class SkillOperationReportContext
{
    ...
    /// <exception cref="ArgumentNullException"> Thrown when <paramref name="hostDescriptor" />, <paramref name="selectedCategories" />, or <paramref name="selectedSkillNames" /> is <see langword="null" />. </exception>
    /// <exception cref="ArgumentException"> Thrown when a selected category or SKILL name is <see langword="null" />. </exception>

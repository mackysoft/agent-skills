...
using MackySoft.AgentDistribution.Cli.Hosting.Cli.Common.Startup;
using MackySoft.AgentDistribution.Cli.Hosting.Composition.Common;
using Microsoft.Extensions.DependencyInjection;

namespace MackySoft.AgentDistribution.Cli.Hosting.Cli.Common.Execution;

/// <summary> Runs the public agent-distribution CLI command pipeline. </summary>
internal sealed class CliExecutionRunner
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var app = AgentDistributionCommandCatalog.RegisterCommands(ConsoleApp.Create());
    ...
    private static ServiceProvider CreateServiceProvider ()
    {
        ...
        services.AddAgentDistributionCliServices();

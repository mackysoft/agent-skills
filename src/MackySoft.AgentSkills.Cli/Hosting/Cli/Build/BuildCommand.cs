...
internal sealed class BuildCommand
{
    ...
    private readonly AgentSkillsBundleBuildService v2BuildService;
    ...
    public BuildCommand (SkillBundleBuildService buildService, AgentSkillsBundleBuildService v2BuildService, BundleSchemaVersionReader schemaVersionReader)
    {
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (schemaResult.Value == AgentSkillsBundleDefinition.CurrentSchemaVersion)
        {
